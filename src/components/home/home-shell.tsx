      ...
      <header className="reveal reveal-delay-1 mb-16 flex items-center justify-between md:mb-24">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            href="https://www.producthunt.com/products/wallabax?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-wallabax"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Open Product Hunt"
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              alt="Wallabax - Turn X articles into clean reader links for Wallabag | Product Hunt"
              width="250"
              height="54"
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1092892&theme=light&t=1773077453415"
            />
          </a>
          <a
